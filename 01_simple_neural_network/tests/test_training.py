...
@description:
This script was written as a test module for the implementation of the training.
...
class TestTraining(unittest.TestCase):
    ...
    def test_regularization(self):
        """ Test the implementation of the regularization. """
    ...
    def test_sgd(self):
        """ Test the implementation of the stochastic gradient descent optimization. """
    ...
    def test_one_layer_train(self):
        """ Test the training of the softmax regression. """
    ...
    def test_two_layer_train(self):
        """ Test the training of the two layer neural network. """
