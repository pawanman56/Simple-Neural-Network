...
@description:
This script was written as a test module for the implementation of the two networks.
...
class TestNetwork(unittest.TestCase):
    ...
    def test_one_layer_softmax_relu(self):
        """ Test the implementation of the softmax regression. """
    ...
    def test_two_layer_net(self):
        """ Test the implementation of the two layer neural network. """
